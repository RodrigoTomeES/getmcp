  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-16">
      ...
      <div className="mb-16">
        ...
        <div className="h-5 w-full max-w-lg rounded bg-surface animate-pulse" />
      </div>

      {/* Section skeletons */}
      {Array.from({ length: 4 }).map((_, i) => (
        <div key={i} className="mb-16">
          <div className="h-7 w-48 rounded bg-surface animate-pulse mb-4" />
          ...
          {i % 2 === 0 && <div className="mt-4 h-32 w-full rounded-lg bg-code-bg animate-pulse" />}
        </div>
      ))}
    </div>
  );
